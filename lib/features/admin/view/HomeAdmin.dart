...
import 'package:auto_parts_app/features/admin/cubit/cubit.dart';
import 'package:auto_parts_app/features/admin/cubit/states.dart';
import 'package:auto_parts_app/features/admin/view/add_ads.dart';
import 'package:auto_parts_app/features/admin/view/add_cat.dart';
import 'package:auto_parts_app/features/user/model/GetAdsModel.dart';
import 'package:auto_parts_app/features/user/view/ads.dart';
                                  ...
                                  SizedBox(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, i) {
                                        String rawImageUrl = cubit.mainCategories[i].images[0];
                                        String cleanImageUrl = rawImageUrl.replaceAll(RegExp(r'[\[\]]'), '');
                                        return GestureDetector(
                                          onTap: (){
                                            navigateTo(context, AdminSubcategoriesPage(parentCategory: cubit.mainCategories[i]));
                                          },
                                          child: Container(
                                                ...
                                                GestureDetector(
                                                  onTap:(){
                                                    cubit.deleteCategories(
                                                        id: cubit.mainCategories[i].id.toString(),
                                                        context: context);
                                                  },
                                                  child: Container(
                                                    width: 35,
