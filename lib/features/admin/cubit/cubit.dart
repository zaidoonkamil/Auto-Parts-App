...
class AdminCubit extends Cubit<AdminStates> {
  ...
  addCat({required String tittle, String? parentId, required BuildContext context,})async{
  ...
  void sendWhatsAppTest({
    ...
    DioHelper.postData(
      ...
      showToastSuccess(text: 'تم إرسال الرسالة التجريبية بنجاح', context: context);
