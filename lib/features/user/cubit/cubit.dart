...
import 'package:auto_parts_app/features/user/cubit/states.dart';
import 'package:auto_parts_app/features/user/model/CatModel.dart';
...
class UserCubit extends Cubit<UserStates> {
  ...
  void getFeaturedProducts({
    ...
    if (loadMore && (isLoadingMoreFeaturedProducts || isLastPageFeaturedProducts)) {
      return;
    }
    ...
    DioHelper.getData(
      ...
      if (currentPageFeaturedProducts >= paginationFeaturedProducts!.totalPages) {
